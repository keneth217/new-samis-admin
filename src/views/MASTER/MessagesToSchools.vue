<template>
  <div class="the-page">
        ...
        <div class="modal-body" v-if="selectedMessageForView">
          <div class="message-details">
            <div class="detail-row">
              <strong>Message ID:</strong> {{ selectedMessageForView.messageID }}
            </div>
            <div class="detail-row">
            ...
            <div class="detail-row" v-if="selectedMessageForView.phoneNo">
              <strong>Phone Number:</strong> {{ selectedMessageForView.phoneNo }}
            </div>
            <div class="detail-row">
    ...
    <div class="modal-wrap" v-if="showDeleteConfirm" @click.self="showDeleteConfirm = false">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
          ...
          <div class="delete-message-preview" v-if="messageToDelete">
            <strong>Message ID:</strong> {{ messageToDelete.messageID }}<br>
            <strong>Subject:</strong> {{ messageToDelete.subject || 'N/A' }}<br>
            <strong>Date:</strong> {{ messageToDelete.sentDate }}
          </div>
          <div class="modal-actions">
            <button @click="showDeleteConfirm = false" class="modal-action-btn cancel-btn">Cancel</button>
            <button @click="deleteMessageConfirm" class="modal-action-btn delete-btn" :disabled="Loading">
              <span class="material-symbols-outlined">delete</span> Delete
            </button>
          </div>
        </div>
